...
export const defineCustomThemes = (monaco) => {
  ...
  monaco.editor.defineTheme('feel', {
    ...
    rules: [
      ...
      { token: 'keyword', foreground: 'EAECEF', fontStyle: 'bold' },
      { token: 'string', foreground: 'B7BDC6' },
      { token: 'number', foreground: 'FACE41' },
      { token: 'function', foreground: 'EAECEF' },
      { token: 'variable', foreground: 'EAECEF' },
      { token: 'type', foreground: 'B7BDC6' },
      { token: 'operator', foreground: 'B7BDC6' },
      { token: 'class', foreground: 'EAECEF' },
      // HTML
      { token: 'tag', foreground: 'EAECEF', fontStyle: 'bold' },
      { token: 'tag.html', foreground: 'EAECEF', fontStyle: 'bold' },
      ...
      // CSS
      { token: 'attribute.name.css', foreground: 'EAECEF' },
