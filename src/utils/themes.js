...
export const defineCustomThemes = (monaco) => {
  ...
  monaco.editor.defineTheme('lite', {
    ...
    inherit: true,
    rules: [
      { token: 'comment', foreground: '7b8698', fontStyle: 'italic' },
      ...
      // HTML
      { token: 'tag', foreground: '7DD3FC', fontStyle: 'bold' },
      { token: 'tag.html', foreground: '7DD3FC', fontStyle: 'bold' },
      { token: 'delimiter.html', foreground: 'CBD5E1' },
      { token: 'attribute.name', foreground: '93C5FD' },
      { token: 'attribute.name.html', foreground: '93C5FD' },
      { token: 'attribute.value', foreground: 'C4B5FD' },
      { token: 'attribute.value.html', foreground: 'C4B5FD' },
      // CSS
      { token: 'attribute.name.css', foreground: '60A5FA' },
      { token: 'attribute.value.css', foreground: 'C4B5FD' },
      { token: 'property.css', foreground: '7DD3FC' },
      // JavaScript
    ...
    colors: {
      ...
      'editor.selectionBackground': '#7DD3FC26',
      'editor.inactiveSelectionBackground': '#7DD3FC14',
      'editor.selectionHighlightBackground': '#C4B5FD14',
      'editor.wordHighlightBackground': '#C4B5FD12',
      'editorIndentGuide.activeBackground': '#334155',
      'editorIndentGuide.background': '#1A2335',
    }
  });
  ...
  monaco.editor.defineTheme('feel', {
    ...
    inherit: true,
    rules: [
      { token: 'comment', foreground: '848E9C', fontStyle: 'italic' },
      { token: 'keyword', foreground: 'FACE41', fontStyle: 'bold' },
      { token: 'keyword.control', foreground: 'FACE41', fontStyle: 'bold' },
      { token: 'keyword.operator', foreground: 'B7BDC6' },
      { token: 'operator', foreground: 'B7BDC6' },
      { token: 'string', foreground: 'B7BDC6' },
      { token: 'string.escape', foreground: 'FACE41' },
      { token: 'number', foreground: 'C4B5FD' },
      { token: 'regexp', foreground: '7DD3FC' },
      { token: 'function', foreground: '7DD3FC' },
      { token: 'variable', foreground: 'EAECEF' },
      { token: 'type', foreground: 'A5B4FC' },
      { token: 'class', foreground: 'A5B4FC' },
      { token: 'delimiter', foreground: 'B7BDC6' },
      { token: 'delimiter.bracket', foreground: 'B7BDC6' },
      { token: 'delimiter.parenthesis', foreground: 'B7BDC6' },
      { token: 'delimiter.square', foreground: 'B7BDC6' },
      { token: 'delimiter.curly', foreground: 'B7BDC6' },
      // HTML
      { token: 'tag', foreground: 'FACE41', fontStyle: 'bold' },
      { token: 'tag.html', foreground: 'FACE41', fontStyle: 'bold' },
      { token: 'delimiter.html', foreground: 'B7BDC6' },
      { token: 'attribute.name', foreground: 'FACE41' },
      { token: 'attribute.name.html', foreground: 'FACE41' },
      { token: 'attribute.value', foreground: 'B7BDC6' },
      { token: 'attribute.value.html', foreground: 'B7BDC6' },
      // CSS
      { token: 'attribute.name.css', foreground: '7DD3FC' },
      { token: 'attribute.value.css', foreground: 'B7BDC6' },
      { token: 'property.css', foreground: 'FACE41' },
      // JavaScript
      { token: 'identifier', foreground: 'EAECEF' },
    ],
    colors: {
      'editor.background': '#181A1F',
      'editor.foreground': '#EAECEF',
      'editorCursor.foreground': '#FACE41',
      'editor.lineHighlightBackground': '#1E2329',
      'editorLineNumber.foreground': '#848E9C',
      'editorLineNumber.activeForeground': '#B7BDC6',
      'editor.selectionBackground': '#FACE4126',
      'editor.inactiveSelectionBackground': '#FACE4114',
      'editor.selectionHighlightBackground': '#FACE4114',
      'editor.wordHighlightBackground': '#FACE4112',
      'editorIndentGuide.activeBackground': '#2B3139',
      'editorIndentGuide.background': '#232A34',
    }
  });
